...
@Component({
	selector: 'app-show-researcher-reviews',
	templateUrl: './show-researcher-reviews.page.html',
	styleUrls: ['./show-researcher-reviews.page.scss'],
})
export class ShowResearcherReviewsPage implements OnInit 
{
