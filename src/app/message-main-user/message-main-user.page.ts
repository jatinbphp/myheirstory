...
@Component({
	selector: 'app-message-main-user',
	templateUrl: './message-main-user.page.html',
	styleUrls: ['./message-main-user.page.scss'],
})
export class MessageMainUserPage implements OnInit 
{
	...
	{ 
		...
		this.client.get_user_messages(data).then(result => 
		{	
